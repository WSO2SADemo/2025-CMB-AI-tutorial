...
`
    }, maxIter = 20, model = _travelPlannerModel, tools = [queryHotelPolicyTool, getPersonalizedProfile, searchHotelsTool, getHotelInfoTool, createBookingTool, checkHotelAvailabilityTool], verbose = true
);
